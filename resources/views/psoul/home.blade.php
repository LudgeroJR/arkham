...
@section('content')
    ...
    <nav class="w-full max-w-4xl mx-auto bg-gradient-to-r from-[#B81F1C] via-[#C6241D] to-[#EA7514] rounded-xl shadow-lg mb-8 sticky top-0 z-20">
    ...
    <div class="bg-white/80 rounded-2xl shadow-2xl p-8 max-w-4xl mx-auto min-h-[440px] flex flex-col items-center relative overflow-x-auto">
        <img src="{{ asset('images/jogos/psoul/logoAnimadaPsoul.png') }}" alt="Logo Psoul" class="h-24 mb-8 drop-shadow-2xl animate-bounce-slow">

        <h1 class="text-4xl md:text-5xl font-extrabold text-[#B81F1C] text-center mb-4 tracking-tight drop-shadow" style="font-family: 'Bebas Neue', Oswald, Arial, sans-serif;">ARKHAM + Psoul<br>Mais que uma parceria, uma jornada!</h1>
        
        <div class="w-full flex flex-col md:flex-row gap-6 justify-center items-stretch mb-6">
            {{-- Crie sua Conta --}}
            <div class="flex-1 bg-gradient-to-br from-[#B81F1C] to-[#C6241D] rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
                <h2 class="text-2xl font-bold text-[#F8EE9A] mb-2">Novo no Psoul?</h2>
                <p class="text-[#F6E160] mb-4">Crie sua conta agora mesmo!</p>
                <a href="https://psoul.gg/pt/r/21000" target="_blank" rel="noopener noreferrer"
                   class="inline-block px-6 py-3 bg-[#EDC416] text-[#B81F1C] font-bold rounded-full shadow-md hover:bg-[#F6E160] hover:text-[#680F0F] transition">
                    Criar Conta
                </a>
            </div>
            {{-- Discord Psoul --}}
            <div class="flex-1 bg-gradient-to-br from-[#EA7514] to-[#C6241D] rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
                <h2 class="text-2xl font-bold text-[#F8EE9A] mb-2">Comunidade</h2>
                <p class="text-[#F6E160] mb-4">Junte-se ao Discord oficial do Psoul!</p>
                <a href="https://discord.gg/psoul" target="_blank" rel="noopener noreferrer"
                   class="whitespace-nowrap px-6 py-3 bg-[#EDC416] text-[#B81F1C] font-bold rounded-full shadow-md hover:bg-[#F6E160] hover:text-[#680F0F] transition flex items-center gap-2">
                    <svg class="w-6 h-6 text-[#B81F1C]" fill="currentColor" viewBox="0 0 24 24"><path d="M20.317 4.369a19.791 19.791 0 00-4.885-1.515.07.07 0 00-.074.035c-.21.372-.444.858-.608 1.245-1.844-.276-3.68-.276-5.486 0-.163-.401-.413-.873-.624-1.245a.07.07 0 00-.073-.035A19.736 19.736 0 003.68 4.369a.064.064 0 00-.03.027C.533 9.09-.32 13.578.099 18.015a.082.082 0 00.031.056c2.052 1.51 4.053 2.42 6.032 3.029a.077.077 0 00.084-.027c.464-.635.877-1.304 1.226-2.013a.076.076 0 00-.041-.104c-.662-.251-1.297-.552-1.918-.892a.076.076 0 01-.008-.128c.129-.097.259-.199.382-.302a.07.07 0 01.071-.01c4.016 1.836 8.374 1.836 12.346 0a.07.07 0 01.073.009c.123.103.253.205.383.302a.076.076 0 01-.007.128c-.621.34-1.256.641-1.918.893a.076.076 0 00-.041.103c.36.709.773 1.378 1.227 2.013a.077.077 0 00.084.028c1.979-.609 3.98-1.52 6.032-3.03a.077.077 0 00.031-.055c.5-5.177-.838-9.637-3.549-13.619a.061.061 0 00-.028-.028zM8.02 15.331c-1.183 0-2.156-1.085-2.156-2.419 0-1.333.955-2.418 2.156-2.418 1.21 0 2.174 1.095 2.156 2.419 0 1.333-.955 2.418-2.156 2.418zm7.974 0c-1.183 0-2.156-1.085-2.156-2.419 0-1.333.955-2.418 2.156-2.418 1.21 0 2.174 1.095 2.156 2.419 0 1.333-.946 2.418-2.156 2.418Z"/></svg>
                    Discord Psoul
                </a>
            </div>
            {{-- Up Guide --}}
            <div class="flex-1 bg-gradient-to-br from-[#EDC416] to-[#F8EE9A] rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
                <h2 class="text-2xl font-bold text-[#B81F1C] mb-2">Guia de UP</h2>
                <p class="text-[#C6241D] mb-4">Descubra onde upar cada Pokémon!</p>
                <a href="https://psoul.gg/upguide/" target="_blank" rel="noopener noreferrer"
                   class="inline-block px-6 py-3 bg-[#B81F1C] text-[#F8EE9A] font-bold rounded-full shadow-md hover:bg-[#EA7514] hover:text-[#EDC416] transition">
                    Acessar Up Guide
                </a>
            </div>
        </div>
        {{-- Instagram Psoul --}}
        <div class="w-full flex flex-col md:flex-row gap-6 justify-center items-stretch mb-6">
            <div class="flex-1 bg-gradient-to-br from-[#F6E160] to-[#EDC416] rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
                <h2 class="text-2xl font-bold text-[#B81F1C] mb-2">Siga no Instagram</h2>
                <p class="text-[#C6241D] mb-4">Conteúdos, novidades, eventos e mais!</p>
                <a href="https://www.instagram.com/psoul_mmo/" target="_blank" rel="noopener noreferrer"
                   class="whitespace-nowrap px-6 py-3 bg-[#B81F1C] text-[#F8EE9A] font-bold rounded-full shadow-md hover:bg-[#EA7514] hover:text-[#EDC416] transition flex items-center gap-2">
        ...
        <div class="text-center mt-8">
            <span class="text-[#C6241D] text-lg font-semibold">Explore o menu acima para acessar tudo que a Arkham tem a oferecer sobre o Psoul!</span>
        </div>
        <style>
