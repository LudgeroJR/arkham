...
@section('content')
    <div
        class="flex h-full max-h-[80vh] bg-gradient-to-br from-[#0F191A] via-[#0B2C21] to-[#0A4327] max-w-[95rem] mx-auto w-full">
        <!-- Sidebar -->
        <aside class="w-64 bg-black/90 border-r-4 border-green-400 flex flex-col py-8 px-4 h-full">
            ...
            <nav class="flex flex-col gap-2">
                <a href="{{ route('admin.profile.show') }}"
                    class="flex items-center px-4 py-2 rounded text-green-200 hover:bg-green-400 hover:text-black font-semibold transition">
                ...
                <div x-data="{ open: false }" class="flex flex-col">
                    <button @click="open = !open"
                        class="flex items-center px-4 py-2 rounded text-green-200 hover:bg-green-400 hover:text-black font-semibold transition focus:outline-none w-full justify-between">
                    ...
                    <div x-show="open" class="ml-6 mt-2 flex flex-col gap-1" x-cloak>
                        <a href="{{ route('admin.psoul.pokedex') }}"
                            class="px-3 py-1 rounded text-green-100 hover:bg-green-400 hover:text-black transition">Pokédex</a>
                        <a href="{{ route('admin.psoul.items') }}"
                            class="px-3 py-1 rounded text-green-100 hover:bg-green-400 hover:text-black transition">Itens</a>
                        <a href="{{ route('admin.psoul.quests') }}"
                            class="px-3 py-1 rounded text-green-100 hover:bg-green-400 hover:text-black transition">Quests</a>
                        <a href="{{ route('admin.psoul.skills') }}"
